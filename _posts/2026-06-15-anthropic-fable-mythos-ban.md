...
last_updated: 2026-06-27 19:32:00 +0930
...
<li><span class="when">As of 27 June</span> Mythos 5 is partially restored, redeployed to about 100 vetted US organisations, while Fable 5 stays offline for everyone else. Congress is split, a disputed NSA red-team claim has surfaced, and no court order touches the export ban. Kalshi traders price a return at ~68% before 1 July.<span class="cite"><button class="cite-btn"></button><span class="cite-pop"><span class="cite-note">Mythos 5 partly back for trusted US orgs; Fable 5 still down. Market odds for full restoration.</span><a href="https://news.bitcoin.com/kalshi-traders-price-fable-5-return-at-68-before-july-1-after-historic-ai-ban/" target="_blank" rel="noopener">Bitcoin.com, Kalshi market odds</a></span></span></li>
</ol>
...
tl;dr: it has started. Mythos 5 is back for vetted US organisations, and Fable 5 looks likely to follow, but probably only for US citizens and permanent residents.
