...
last_updated: 2026-06-22 00:16:00 +0930
...
<li><span class="when">As of 22 June</span> Models still offline; Trump has softened his posture but stopped short of lifting the ban, the UK was refused a carve-out, and no court order touches the export ban. Kalshi traders price a return at ~68% before 1 July.<span class="cite"><button class="cite-btn"></button><span class="cite-pop"><span class="cite-note">Still suspended; market odds for restoration.</span><a href="https://news.bitcoin.com/kalshi-traders-price-fable-5-return-at-68-before-july-1-after-historic-ai-ban/" target="_blank" rel="noopener">Bitcoin.com, Kalshi market odds</a></span></span></li>
</ol>
...
Semafor reported the deeper worry was that a China-linked group may have accessed Mythos and could copy or weaponise its bug-finding. Notably, Anthropic pushed back, saying the White House didn't raise Chinese access in their conversations, so the stated reason and the reported reason don't fully line up.<span class="cite"><button class="cite-btn"></button><span class="cite-pop"><span class="cite-note">China-access theory vs Anthropic's denial it was raised.</span><a href="https://www.semafor.com/article/06/13/2026/white-house-move-to-limit-anthropic-linked-to-concerns-about-chinese-access-to-mythos" target="_blank" rel="noopener">Semafor, the China reporting</a></span></span> <span class="upd" data-date="2026-06-19">Later reporting traced that worry to a specific global telecoms company that had been cleared for limited Mythos Preview access; Anthropic says it revoked the access when the government raised concerns, weeks before the ban.<span class="cite"><button class="cite-btn"></button><span class="cite-pop"><span class="cite-note">Per Semafor (via The Verge), the China rumour traces to a global telecom cleared for Mythos Preview; Anthropic revoked access when concerns were raised.</span><a href="https://www.theverge.com/ai-artificial-intelligence/950412/anthropic-trump-adminstration-claude-mythos-fable-5-export-controls" target="_blank" rel="noopener">The Verge (citing Semafor)</a></span></span></span>
